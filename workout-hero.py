...
class WorkoutHeroIntentHandler(AbstractRequestHandler):
    """Handler for Hello World Intent."""

    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return is_intent_name("WorkoutHeroIntent")(handler_input)
...
sb.add_request_handler(WorkoutHeroIntentHandler())
...
user: dict = {
    ...
    "firstName": "Brad",
    "lastName": "Warnick",
    "email": "bwarnoh@gmail.com",
    "joinedTimestamp": 1550786146,
    "lastUsedTimestamp": 1550786146,
    "startTodayTimestamp": 1550786146,
    "birthdayDate": 1550786146,
    "programs": [
        {
            "pid:": 10000,
            "order": 1,
